...
import cheatingessentials.mod.internal.ttf.FontHandler;
import cheatingessentials.mod.internal.ttf.StringCache;

import com.ibm.icu.text.ArabicShaping;
import com.ibm.icu.text.ArabicShapingException;
import com.ibm.icu.text.Bidi;

public class FontRendering implements IResourceManagerReloadListener
{
    ...
    public FontRendering(GameSettings par1GameSettings, ResourceLocation par2ResourceLocation, TextureManager par3TextureManager, boolean par4)
    {
       ...
       //TODO: TTF
        ...
        if (FontHandler.getInstance().isGlobalTTF()) {
                ...
                stringCache.setDefaultFont(FontHandler.getInstance().getFontName(),
                                FontHandler.getInstance().getFontSize(), true);
        }
        //End
    }
    ...
    public int drawString(String par1Str, int par2, int par3, int par4, boolean par5)
    {
        ...
        {
        	if (FontHandler.getInstance().isGlobalTTF()) {
           	 var6 = renderString(par1Str, par2 + 0.74f, par3 + 0.74f, par4, true);
     ...
     */
    private int renderString(String par1Str, final float par2, final float par3, int par4, final boolean par5) {
    	//for(Friend friend: YouAlwaysWin.getFriends().friendsList)
		// {
		//	 par1Str = par1Str.replace(friend.getName(), "\247a" + friend.getAlias() + "\247a");
		// }
    ...
    {
    	if ((stringCache != null) && FontHandler.getInstance().isGlobalTTF()) {
