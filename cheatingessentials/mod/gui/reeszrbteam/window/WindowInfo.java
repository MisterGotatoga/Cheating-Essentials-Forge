...
public class WindowInfo extends YAWWindow{
	...
	public void draw(int x, int y)
	{
		if(isOpen())
		{
			...
			if(isExtended())
			{
				GLUtils.drawGradientBorderedRect(getX() + dragX, getY() + 14 + dragY, getX() + 90 + dragX, getY() + 84 + dragY, 0.5F, 0xFF000000, 0xFF999999, 0xFF777777);
				...
				Minecraft.getMinecraft().fontRenderer.drawStringWithShadow("Ver.: "+CheatingEssentials.version.replace("-", ""), getX() + 2 + dragX, getY() + 35 + dragY, 0x55FFFF);
