...
import net.cheatingessentials.client.command.CommandAddEnemy;
import net.cheatingessentials.client.command.CommandAddFriend;
import net.cheatingessentials.client.command.CommandBlockESP;
import net.cheatingessentials.client.command.CommandBlockFinderRadius;
import net.cheatingessentials.client.command.CommandBreadcrumbClear;
import net.cheatingessentials.client.command.CommandFlySpeed;
import net.cheatingessentials.client.command.CommandModuleHelp;
import net.cheatingessentials.client.command.CommandModuleList;
import net.cheatingessentials.client.command.CommandModuleToggle;
import net.cheatingessentials.client.command.CommandSMKeybind;
import net.cheatingessentials.client.command.CommandSpeedValue;
import net.cheatingessentials.client.command.CommandStepHeight;
import net.cheatingessentials.client.command.CommandXray;
...
public final class CheatingEssentials
{
	...
	public void preInitialization(FMLPreInitializationEvent e)
	{
		...
		mMetadata.authorList = Arrays.asList(new String[] { "Kodehawa", "ReesZRB" });
	...
	public void postInitialization(FMLPostInitializationEvent e)
	{
		...
		{
			//This should happen only if someone deletes a module.
		}
	...
	{		
		...
		{
			//This only should happen if someone deletes a module.
		}
	}
	...
	private String majorVersion = "4", minorVersion = "2", revision = "1", status = "";
